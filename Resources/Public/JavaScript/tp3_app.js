...
var scroll_pos = $j(document).scrollTop(),
    ...
    headerwidth = $j('header').width(),
    logoheight = $j('#logo').height() -10,
    logowidth = $j('#logo').width(),
    ...
    if(mobile != true || headerwidth > 600) {
        ...
        if(scroll_pos  == (headerPos)) {
            ...
            show = setTimeout(function() {
                ...
                $j(' a.navbar-brand-image, #logo').width((logoheight/headerheight)*logowidth).height(headerheight *0.8 );
        ...
        if(scrollPos > headerPos && scroll_pos <= scrollPos) {
            ...
            if(once === true) {
                ...
                go = setTimeout(function() {
                    ...
                    $j(' a.navbar-brand-image, #logo').width((logoheight/headerheight)*logowidth).height(headerheight /2  );
       ...
       // headerheight = 100 ;
        ...
        $j('a.navbar-brand-image, #logo').width(headerwidth < 992 ? (logoheight/headerheight)*logowidth : (logoheight/headerheight)*logowidth * 0.7).height(headerheight * 0.7);
