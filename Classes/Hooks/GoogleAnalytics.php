...
class GoogleAnalytics
{
     ...
     *
     * @param array $content
     * @param string $conf TyposcriptConfig
  ...
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
     ...
     *
     * @param string $con      Pagecontent
     * @param string $gaCode   Google Analytics Tracker Code
     * @param string $position Position of the Tracker Code in the html document
     * @return string          Pagecontent
     *
     */
    protected function insertTrackerCode($con, $gaCode, $position)
    {
        ...
        if ($GLOBALS ['TSFE']->fe_user->getKey('ses', 'privacyPopup') != 1) {
            $GLOBALS ['TSFE']->fe_user->setKey('ses', 'privacyPopup', 1);
        }
