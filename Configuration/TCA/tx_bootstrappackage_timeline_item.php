...
return [
    'ctrl' => [
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
    ...
    'palettes' => [
        ...
        'visibility' => [
            'showitem' => '
                hidden;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item
            '
        ],
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.tt_content',
            'config' => [
                'type' => 'select',
        ...
        'date' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.date',
            'config' => [
                'type' => 'input',
                'renderType' => 'inputDateTime',
                'dbType' => 'date',
        ...
        'header' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.header',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim,required'
        ...
        'bodytext' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.bodytext',
        ...
        'icon_file' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.icon_file',
        ...
        'image' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item.image',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                'image',
                [
                    'appearance' => [
