...
return [
    'ctrl' => [
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
    ...
    'palettes' => [
        ...
        'visibility' => [
            'showitem' => '
                hidden;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item
            '
        ],
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.tt_content',
            'config' => [
                'type' => 'select',
        ...
        'header' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.header',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim,required'
        ...
        'subheader' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.subheader',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim'
        ...
        'link' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.link',
            'config' => [
                'type' => 'input',
                ...
                'fieldControl' => [
                    'linkPopup' => [
                        'options' => [
                            'title' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.link',
                        ],
                    ],
                ],
                'softref' => 'typolink'
        ...
        'icon_file' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item.icon_file',
