...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:content_element.accordion',
        'accordion',
...
$GLOBALS['TCA']['tt_content']['types']['accordion'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:accordion.options,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_accordion_item' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:accordion_item',
            'config' => [
                'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:tp3mods/Configuration/FlexForms/Accordion.xml',
    'accordion'
);
