...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:content_element.timeline',
        'timeline',
...
$GLOBALS['TCA']['tt_content']['types']['timeline'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline.options,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_timeline_item' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:timeline_item',
            'config' => [
                'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:tp3mods/Configuration/FlexForms/Timeline.xml',
    'timeline'
);
