...
$GLOBALS['TCA']['tt_content']['columns']['readmore_label'] = [
    'exclude' => true,
    'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:field.readmore_label',
    'config' => [
        'type' => 'input',
        'eval' => 'trim',
        'size' => 50,
...
$GLOBALS['TCA']['tt_content']['columns']['teaser'] = [
    'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:field.teaser',
    'exclude' => true,
    'config' => [
        'type' => 'text',
...
$GLOBALS['TCA']['tt_content']['columns']['tx_bootstrappackage_carousel_item'] = [
    'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:carousel_item',
    'config' => [
        'type' => 'inline',
...
$GLOBALS['TCA']['tt_content']['columns']['file_folder'] = [
    'exclude' => true,
    'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:field.file_folder',
    'config' => [
        'type' => 'group',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'imageorient',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:field.imageorient.125',
        (string) 125,
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'imageorient',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:field.imageorient.126',
        (string) 126,
