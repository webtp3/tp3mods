...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:content_element.icon_group',
        'icon_group',
...
$GLOBALS['TCA']['tt_content']['types']['icon_group'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:content_element.icon_group.options,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_icon_group_item' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:icon_group_item',
            'config' => [
                'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:tp3mods/Configuration/FlexForms/IconGroup.xml',
    'icon_group'
);
