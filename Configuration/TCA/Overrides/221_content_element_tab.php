...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:content_element.tab',
        'tab',
...
$GLOBALS['TCA']['tt_content']['types']['tab'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:tab.options,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_tab_item' => [
            'label' => 'LLL:EXT:tp3mods/Resources/Private/Language/Backend.xlf:tab_item',
            'config' => [
                'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:tp3mods/Configuration/FlexForms/Tab.xml',
    'tab'
);
